#!/bin/bash
#This is an updated version of the previous menu.bash
#There is now an option in the security menu to create inbound drop rulesets by calling parse-threat.bash
